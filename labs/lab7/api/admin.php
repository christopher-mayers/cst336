    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                //Gets products from the database and displays them
                $.ajax({
                    ...
                    success: function(data,status) {
                      ...
                      data.forEach(function(product){
                          $("#products").append("<div class='row'>" + 
                                                ...
                                                //"[ <a href='delete.php?productId=" + product.productId +"'> Delete </a>]" + product.productName + "</div>"+
                                                "<form action = 'delete.php' method='post' onsubmit='return confirmDelete()'>" +
                                                "<input type = 'hidden' name = 'productId' value = '"+product.productId + "'>"+
                                                "<button class='btn btn-danger'>Delete</button>" +
                                                "</form>" + 
                                                "<a target='productIframe' onclick='openModal()' href='productInfo.php?productId=" + product.productId +"'>"+
                                                product.productName + 
                                                "</a>" + "</div>" +
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <iframe name = "productIframe" width = "400" height = "400">
